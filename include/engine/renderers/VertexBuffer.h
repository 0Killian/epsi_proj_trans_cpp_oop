...
public:
    ...
    virtual void SetData(const T* data, size_t size) = 0;
    virtual void UpdateData(const T* data, size_t size, size_t offset) = 0;
    [[nodiscard]] virtual Mapping Map(size_t offset, size_t size) = 0;
